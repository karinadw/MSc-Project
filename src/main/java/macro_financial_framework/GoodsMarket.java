                ...
                while (demandFromHousehold > 0){
                    ...
                    if (firmToPurchaseFrom.isPresent()){
                        ...
                        if (quantityDemanded == 0) {
                            ...
                            goodMarket.firmsSupplyingGoods.remove(firmToPurchaseFrom.get());
                            goodMarket.firmsSupplyingGoods.add(new FirmSupplyInformation(firmToPurchaseFrom.get().ID, quantityAvailable - quantityDemanded, firmToPurchaseFrom.get().price));
